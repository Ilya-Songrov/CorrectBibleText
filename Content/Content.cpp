...
void Content::generateContent_Folders(const Content::ProviderContent typeContent, const bool onlyRemove)
{
...
void Content::generateContentStandart(const Content::Standard requiredStandart, const ProviderContent providerContent)
{
    testGetIndexBook();
...
void Content::getVectorVersesAllBible(QVector<QPair<QString, QString> > *vecPair, const Content::ProviderContent provider)
{
...
void Content::generateContent_TwoArraysBooks(const ProviderContent typeContent)
{
    const int Old_New_Testament { 2 };
    for (int var = 0; var < Old_New_Testament; ++var) {
